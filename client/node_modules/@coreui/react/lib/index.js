...
var CFade = function CFade(props) {
  var Tag = props.tag,
      ...
      rest = objectWithoutProperties(props, ["tag", "className", "children", "innerRef", "baseClass", "baseClassActive"]); //render


  var transitionProps = pickByKeys(rest, TransitionPropTypeKeys);
  var childProps = omitByKeys(rest, TransitionPropTypeKeys);
  var ref = _typeof_1(innerRef) === 'object' ? innerRef : React.useRef();
  typeof innerRef === 'function' && innerRef(ref);
  return /*#__PURE__*/React__default['default'].createElement(Transition, _extends_1({}, transitionProps, {
    nodeRef: ref
  }), function (status) {
    var isActive = status === 'entered';
    var classes = classnames(className, baseClass, isActive && baseClassActive);
    return /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({
      className: classes
    }, childProps, {
      ref: ref
    }), children);
...
var CButtonClose = function CButtonClose(props) {
  var children = props.children,
      ...
      innerRef = props.innerRef,
      attributes = objectWithoutProperties(props, ["children", "className", "buttonClass", "innerRef"]); //render
...
var CAlert = function CAlert(props) {
  ...
  var children = props.children,
      ...
      fade = props.fade,
      show = props.show,
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef", "onShowChange", "closeButton", "color", "fade", "show"]); //render


  var classes = classnames(className, 'alert', (_classNames = {}, defineProperty(_classNames, "alert-".concat(color), color), defineProperty(_classNames, 'alert-dismissible', closeButton), _classNames));
  var alertTransition = {
  ...
  return /*#__PURE__*/React__default['default'].createElement(CFade, _extends_1({}, alertTransition, {
    className: classes,
    in: Boolean(isOpen),
    role: "alert"
  }, attrs, {
...
var CLink = function CLink(props) {
  var className = props.className,
      ...
      rest = objectWithoutProperties(props, ["className", "innerRef", "active", "href", "onClick", "disabled"]);
  ...
  return to ? /*#__PURE__*/React__default['default'].createElement(reactRouterDom.NavLink, _extends_1({}, rest, {
    className: classes,
    onClick: click,
    ref: innerRef
  })) : /*#__PURE__*/React__default['default'].createElement("a", _extends_1({
    href: href || '#',
    className: classes,
...
var CBadge = function CBadge(props) {
  ...
  var tag = props.tag,
      ...
      color = props.color,
      shape = props.shape,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "color", "shape"]); // render


  var classes = classnames(className, 'badge', (_classNames = {}, defineProperty(_classNames, "badge-".concat(color), color), defineProperty(_classNames, "badge-".concat(shape), shape), _classNames));
  var Tag = attributes.to || attributes.href ? CLink : tag;

  var ref = defineProperty({}, "".concat(typeof Tag === 'string' ? 'ref' : 'innerRef'), innerRef);
...
var CButton = function CButton(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "onClick", "disabled", "active", "block", "color", "size", "pressed", "shape", "variant"]);
  ...
  if (isLink) {
    return /*#__PURE__*/React__default['default'].createElement(CLink, _extends_1({}, attributes, {
      active: active,
      disabled: disabled,
      className: classes,
      onClick: click,
...
var CButtonGroup = function CButtonGroup(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "size", "vertical"]); //render


  var classes = classnames(className, size ? 'btn-group-' + size : false, vertical ? 'btn-group-vertical' : 'btn-group');
  return /*#__PURE__*/React__default['default'].createElement("div", _extends_1({
    className: classes,
    role: "group"
  }, attributes, {
    ref: innerRef
...
var CButtonToolbar = function CButtonToolbar(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "justify"]); //render


  var classes = classnames(className, 'btn-toolbar', defineProperty({}, "justify-content-".concat(justify), justify));
  return /*#__PURE__*/React__default['default'].createElement("div", _extends_1({
    className: classes,
    role: "toolbar",
    "aria-label": "toolbar"
...
var CBreadcrumb = function CBreadcrumb(props) {
  var className = props.className,
      innerRef = props.innerRef,
      attributes = objectWithoutProperties(props, ["className", "innerRef"]);
...
var CBreadcrumbRouter = function CBreadcrumbRouter(props) {
  var className = props.className,
      innerRef = props.innerRef,
      routes = props.routes,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "routes"]);
  ...
  if (routes) {
    ...
    var currRoutes = paths.map(function (currPath) {
      ...
      return _objectSpread$1(_objectSpread$1({}, route), {}, {
        currPath: currPath
      });
  ...
  return /*#__PURE__*/React__default['default'].createElement(CBreadcrumb, _extends_1({
    className: classes
  }, attributes, {
    ref: innerRef
  }), items);
...
var CBreadcrumbItem = function CBreadcrumbItem(props) {
  var className = props.className,
      innerRef = props.innerRef,
      active = props.active,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "active"]); //render
...
var CCallout = function CCallout(props) {
  var className = props.className,
      innerRef = props.innerRef,
      color = props.color,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "color"]); //render
...
var CCard = function CCard(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "color", "textColor", "borderColor", "align", "accentColor"]); //render
...
CCard.propTypes = _objectSpread$2({
  tag: tagPropType,
  className: propTypes.oneOfType([propTypes.string, propTypes.array, propTypes.object]),
  //
  innerRef: propTypes.oneOfType([propTypes.object, propTypes.func]),
...
var CCardBody = function CCardBody(props) {
  var Tag = props.tag,
      ...
      borderColor = props.borderColor,
      align = props.align,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "color", "textColor", "borderColor", "align"]); //render
...
CCardBody.propTypes = _objectSpread$3({
  tag: tagPropType,
  className: propTypes.oneOfType([propTypes.string, propTypes.array, propTypes.object]),
  //
  innerRef: propTypes.oneOfType([propTypes.object, propTypes.func])
...
CCardHeader.propTypes = _objectSpread$4({
  tag: tagPropType,
  className: propTypes.oneOfType([propTypes.string, propTypes.array, propTypes.object]),
  //
  innerRef: propTypes.oneOfType([propTypes.object, propTypes.func])
...
CCardFooter.propTypes = _objectSpread$5({
  tag: tagPropType,
  className: propTypes.oneOfType([propTypes.string, propTypes.array, propTypes.object]),
  //
  innerRef: propTypes.oneOfType([propTypes.object, propTypes.func])
...
var CCardGroup = function CCardGroup(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "deck", "columns"]); //render
...
var CImg = function CImg(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "fluid", "block", "thumbnail", "shape", "align", "src", "width", "height", "placeholderColor", "fluidGrow"]);
  ...
  return src ? /*#__PURE__*/React__default['default'].createElement("img", _extends_1({
    className: classes,
    src: src,
    width: width,
    height: height
    ...
    ref: innerRef
  })) : /*#__PURE__*/React__default['default'].createElement("svg", _extends_1({
    className: classes,
    width: width,
    height: height,
    style: {
...
var CCardImg = function CCardImg(props) {
  var variant = props.variant,
      rest = objectWithoutProperties(props, ["variant"]);

  var classSuffix = variant !== 'full' ? "-".concat(variant) : '';
  return /*#__PURE__*/React__default['default'].createElement(CImg, _extends_1({}, rest, {
...
var CCardImgOverlay = function CCardImgOverlay(props) {
  var Tag = props.tag,
      className = props.className,
      innerRef = props.innerRef,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef"]); //render


  var classes = classnames(className, 'card-img-overlay');
  return /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({}, attributes, {
    className: classes,
    ref: innerRef
  }));
};
...
var CCardLink = function CCardLink(props) {
  return /*#__PURE__*/React__default['default'].createElement(CLink, _extends_1({}, props, {
...
var Context = /*#__PURE__*/React__default['default'].createContext({}); //component - CoreUI / CCarousel
...
var CCarousel = function CCarousel(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "autoSlide", "activeIndex", "animate", "onSlideChange"]);
...
var CCarouselItem = function CCarouselItem(props) {
  var children = props.children,
      className = props.className,
      innerRef = props.innerRef,
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef"]);
...
var CCarouselControl = function CCarouselControl(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "children", "innerRef", "direction"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement("a", _extends_1({
...
var CCarouselIndicators = function CCarouselIndicators(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "indicatorsClass"]);
...
var CCarouselCaption = function CCarouselCaption(props) {
  var className = props.className,
      innerRef = props.innerRef,
      attributes = objectWithoutProperties(props, ["className", "innerRef"]); //render
...
var CCollapse = function CCollapse(props) {
  var children = props.children,
      ...
      show = props.show,
      navbar = props.navbar,
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef", "show", "navbar"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Transition, {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", _extends_1({}, attributes, {
      style: _objectSpread$6(_objectSpread$6({}, attributes.style), style),
      className: classes,
      ref: ref
    }), children);
  });
...
var CCreateElement = function CCreateElement(_ref) {
  ...
  var renderItem = function renderItem(item, i) {
    var _tag = item._tag,
        ...
        rest = objectWithoutProperties(item, ["_tag", "_children"]);

    var Tag = components[_tag] || _tag;
    var children = _children ? _children.map(function (child, i) {
      return _typeof_1(child) === 'object' ? renderItem(child, i) : child;
    }) : '';
    return /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({
      key: Tag + i
    }, rest), children);
...
var Context$1 = /*#__PURE__*/React__default['default'].createContext({}); //component - CoreUI / CDropdown
...
var CDropdown = function CDropdown(props) {
  var className = props.className,
      ...
      innerRef = props.innerRef,
      inNav = props.inNav,
      attributes = objectWithoutProperties(props, ["className", "tag", "innerRef", "inNav"]);
  ...
  }, /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({
    className: classes
  }, attributes, {
    ref: innerRef
  })));
...
var CDropdownItem = function CDropdownItem(props) {
  var tag = props.tag,
      ...
      active = props.active,
      disabled = props.disabled,
      rest = objectWithoutProperties(props, ["tag", "className", "innerRef", "onClick", "color", "divider", "header", "active", "disabled"]);
...
var CDropdownDivider = function CDropdownDivider(props) {
  return /*#__PURE__*/React__default['default'].createElement(CDropdownItem, _extends_1({}, props, {
    divider: true
  }));
};
...
var CDropdownMenu = function CDropdownMenu(props) {
  var className = props.className,
      ...
      innerRef = props.innerRef,
      rest = objectWithoutProperties(props, ["className", "show", "placement", "modifiers", "innerRef"]);
...
var CDropdownToggle = function CDropdownToggle(props) {
  ...
  var className = props.className,
      ...
      split = props.split,
      tag = props.tag,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "onClick", "caret", "split", "tag"]);
  ...
  }, defineProperty(_togglerAttrs, "".concat(tag && typeof tag === 'string' ? 'ref' : 'innerRef'), setReference), defineProperty(_togglerAttrs, 'role', Tag === CButton ? null : 'button'), _togglerAttrs);

  if (split) {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(CButton, attributes, props.children), /*#__PURE__*/React__default['default'].createElement(CButton, _extends_1({
...
var CSpinner = function CSpinner(props) {
  var Tag = props.tag,
      ...
      size = props.size,
      color = props.color,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "grow", "size", "color"]); //render
...
var CElementCover = function CElementCover(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "children", "innerRef", "boundaries", "opacity"]);
...
var CEmbed = function CEmbed(props) {
  var Tag = props.tag,
      ...
      innerRef = props.innerRef,
      ratio = props.ratio,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "ratio"]); //render
...
var CForm = function CForm(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "inline", "wasValidated"]); //render
...
var CFormFeedback = function CFormFeedback(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "valid", "tooltip"]); //render
...
var CValidFeedback = function CValidFeedback(props) {
  return /*#__PURE__*/React__default['default'].createElement(CFormFeedback, _extends_1({}, props, {
    valid: true
  }));
};
...
var CCol = function CCol(props) {
  var Tag = props.tag,
      ...
      innerRef = props.innerRef,
      widths = props.widths,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "widths"]); //render
  ...
  widths.forEach(function (colWidth, i) {
    ...
    if (_typeof_1(columnProp) === 'object') {
      var _classNames;

      var colSizeInterfix = isXs ? '-' : "-".concat(colWidth, "-");
      var colClass = getColumnSizeClass(isXs, colWidth, columnProp.size);
      colClasses.push(classnames((_classNames = {}, defineProperty(_classNames, colClass, columnProp.size || columnProp.size === ''), defineProperty(_classNames, "order".concat(colSizeInterfix).concat(columnProp.order), columnProp.order || columnProp.order === 0), defineProperty(_classNames, "offset".concat(colSizeInterfix).concat(columnProp.offset), columnProp.offset || columnProp.offset === 0), _classNames)));
    } else {
...
var CLabel = function CLabel(props) {
  var tag = props.tag,
      ...
      variant = props.variant,
      col = props.col,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "hidden", "variant", "col"]); // render
...
var CFormGroup = function CFormGroup(props) {
  var className = props.className,
      ...
      variant = props.variant,
      inline = props.inline,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "row", "disabled", "variant", "inline"]); //render
...
var CFormText = function CFormText(props) {
  var Tag = props.tag,
      ...
      innerRef = props.innerRef,
      color = props.color,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "color"]); //render
...
var CInput = function CInput(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "type", "valid", "invalid", "plaintext", "size", "sizeHtml"]); // render
  ...
  return /*#__PURE__*/React__default['default'].createElement("input", _extends_1({
    className: classes,
    type: type
  }, attributes, {
    size: sizeHtml,
...
CInput.propTypes = _objectSpread$8(_objectSpread$8({}, commonPropTypes), {}, {
...
var CTextarea = function CTextarea(props) {
  var className = props.className,
      ...
      plaintext = props.plaintext,
      size = props.size,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "valid", "invalid", "plaintext", "size"]); // render


  var classes = classnames(plaintext ? 'form-control-plaintext' : 'form-control', size && "form-control-".concat(size), invalid && 'is-invalid', valid && 'is-valid', className);
  return /*#__PURE__*/React__default['default'].createElement("textarea", _extends_1({
    className: classes
  }, attributes, {
    ref: innerRef
  }));
...
CTextarea.propTypes = _objectSpread$8(_objectSpread$8({}, commonPropTypes), {}, {
  plaintext: propTypes.bool,
  size: propTypes.string
});
...
var CInputFile = function CInputFile(props) {
  var className = props.className,
      ...
      invalid = props.invalid,
      custom = props.custom,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "valid", "invalid", "custom"]); // render
...
CInputFile.propTypes = _objectSpread$8(_objectSpread$8({}, commonPropTypes), {}, {
...
CInputCheckbox.propTypes = _objectSpread$8(_objectSpread$8({}, commonPropTypes), {}, {
  custom: propTypes.bool
});

var CInputRadio = function CInputRadio(props) {
  return /*#__PURE__*/React__default['default'].createElement(CInputCheckbox, _extends_1({}, props, {
    type: "radio"
  }));
};
...
var CSelect = function CSelect(props) {
  var className = props.className,
      ...
      sizeHtml = props.sizeHtml,
      custom = props.custom,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "valid", "invalid", "size", "sizeHtml", "custom"]); // render
  ...
  return /*#__PURE__*/React__default['default'].createElement("select", _extends_1({
    className: classes
  }, attributes, {
    size: sizeHtml,
    ref: innerRef
...
CSelect.propTypes = _objectSpread$8(_objectSpread$8({}, commonPropTypes), {}, {
  size: propTypes.string,
  sizeHtml: propTypes.oneOfType([propTypes.string, propTypes.number])
});
...
var CInputGroup = function CInputGroup(props) {
  var className = props.className,
      innerRef = props.innerRef,
      size = props.size,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "size"]); //render
...
var CInputGroupAddon = function CInputGroupAddon(props) {
  var children = props.children,
      ...
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef", "prepend"]); //render
...
var CInputGroupAppend = function CInputGroupAppend(props) {
  return /*#__PURE__*/React__default['default'].createElement(CInputGroupAddon, _extends_1({}, props, {
    prepend: false
  }));
};
...
var CRow = function CRow(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "gutters", "form", "alignHorizontal", "alignVertical"]); //render
...
var CContainer = function CContainer(props) {
  var Tag = props.tag,
      ...
      innerRef = props.innerRef,
      fluid = props.fluid,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "fluid"]); //render
...
var CListGroup = function CListGroup(props) {
  ...
  var Tag = props.tag,
      ...
      flush = props.flush,
      accent = props.accent,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "horizontal", "flush", "accent"]); // render


  var classes = classnames(className, 'list-group', (_classNames = {}, defineProperty(_classNames, "list-group-horizontal-".concat(horizontal), horizontal), defineProperty(_classNames, 'list-group-flush', flush), defineProperty(_classNames, 'list-group-accent', accent), _classNames));
  return /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({
    className: classes,
    role: "list-items"
  }, attributes, {
...
var CListGroupItem = function CListGroupItem(props) {
  ...
  var Tag = props.tag,
      ...
      color = props.color,
      accent = props.accent,
      rest = objectWithoutProperties(props, ["tag", "className", "innerRef", "active", "disabled", "action", "color", "accent"]); //render
  ...
  var classes = classnames(className, 'list-group-item', (_classNames = {
    ...
    active: active,
    disabled: disabled
  }, defineProperty(_classNames, "list-group-item-".concat(color), color), defineProperty(_classNames, "list-group-item-accent-".concat(accent), accent), _classNames));

  if (props.href || props.to) {
    return /*#__PURE__*/React__default['default'].createElement(CLink, _extends_1({}, rest, {
      className: classes,
      innerRef: innerRef
    }));
  } else {
    return /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({}, rest, {
      className: classes,
      ref: innerRef
    }));
  }
...
var CModal = function CModal(props) {
  var innerRef = props.innerRef,
      ...
      className = props.className,
      attributes = objectWithoutProperties(props, ["innerRef", "show", "centered", "size", "color", "borderColor", "fade", "backdrop", "closeOnBackdrop", "onOpened", "onClosed", "addContentClass", "onClose", "className"]);
  ...
  var modalClasses = classnames('modal overflow-auto fade', defineProperty({}, "modal-".concat(color), color), className);
  var dialogClasses = classnames('modal-dialog', defineProperty({
    'modal-dialog-centered': centered
  }, "modal-".concat(size), size));
  var contentClasses = classnames('modal-content', defineProperty({}, "border-".concat(borderColor), borderColor), addContentClass);
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      role: "document"
    }, /*#__PURE__*/React__default['default'].createElement("div", _extends_1({}, attributes, {
...
var CModalHeader = function CModalHeader(props) {
  var Tag = props.tag,
      ...
      innerRef = props.innerRef,
      closeButton = props.closeButton,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "closeButton"]);
...
var CNav = function CNav(props) {
  ...
  var Tag = props.tag,
      ...
      fill = props.fill,
      inCard = props.inCard,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "variant", "vertical", "justified", "fill", "inCard"]);

  var verticalClass = "flex".concat(vertical === true ? '' : "-".concat(vertical), "-column"); //render

  var classes = classnames('nav', vertical && verticalClass, (_classNames = {}, defineProperty(_classNames, "nav-".concat(variant), variant), defineProperty(_classNames, 'nav-justified', justified), defineProperty(_classNames, 'nav-fill', fill), defineProperty(_classNames, "card-header-".concat(variant), inCard && variant), _classNames), className);
  return /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({
    className: classes
  }, attributes, {
    ref: innerRef
...
var Context$3 = /*#__PURE__*/React__default['default'].createContext();
...
var CTabs = function CTabs(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Context$3.Provider, {
    value: {
      active: active,
...
var CNavLink = function CNavLink(props) {
  var innerRef = props.innerRef,
      className = props.className,
      onClick = props.onClick,
      rest = objectWithoutProperties(props, ["innerRef", "className", "onClick"]);

  var tabState = React.useContext(Context$3);
  ...
  return /*#__PURE__*/React__default['default'].createElement(CLink, _extends_1({
    active: active
  }, rest, {
    innerRef: ref,
    onClick: click,
...
var CNavbarBrand = function CNavbarBrand(props) {
  return /*#__PURE__*/React__default['default'].createElement(CBrand, _extends_1({}, props, {
...
var CNavbar = function CNavbar(props) {
  ...
  var Tag = props.tag,
      ...
      sticky = props.sticky,
      color = props.color,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "expandable", "light", "fixed", "sticky", "color"]); //render


  var classes = classnames('navbar', className, light ? 'navbar-light' : 'navbar-dark', (_classNames = {}, defineProperty(_classNames, "navbar-expand".concat(expandable === true ? '' : "-".concat(expandable)), expandable), defineProperty(_classNames, "bg-".concat(color), color), defineProperty(_classNames, "fixed-".concat(fixed), fixed), defineProperty(_classNames, 'sticky-top', sticky), _classNames));
  return /*#__PURE__*/React__default['default'].createElement(Tag, _extends_1({
    className: classes
  }, attributes, {
    ref: innerRef
...
var CPagination = function CPagination(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "addListClass", "activePage", "size", "firstButton", "previousButton", "nextButton", "lastButton", "dots", "arrows", "doubleArrows", "limit", "pages", "align", "onActivePageChange"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement("nav", _extends_1({
    className: className,
...
var CProgressBar = function CProgressBar(directProps) {
  ...
  var props = _objectSpread$9(_objectSpread$9({}, inheritedProps), directProps);
  ...
  var children = props.children,
      ...
      max = props.max,
      value = props.value,
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef", "color", "striped", "animated", "precision", "showPercentage", "showValue", "max", "value"]); // render
...
var Context$4 = /*#__PURE__*/React__default['default'].createContext({}); //component - CoreUI / CProgress
...
var CProgress = function CProgress(props) {
  var children = props.children,
      ...
      max = props.max,
      value = props.value,
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef", "size", "color", "striped", "animated", "precision", "showPercentage", "showValue", "max", "value"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", _extends_1({
    ...
    ref: innerRef
  }), /*#__PURE__*/React__default['default'].createElement(Context$4.Provider, {
    value: {
...
var CSwitch = function CSwitch(props) {
  var className = props.className,
      ...
      variant = props.variant,
      shape = props.shape,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "size", "color", "labelOn", "labelOff", "variant", "shape"]); //render
  ...
  return /*#__PURE__*/React__default['default'].createElement("label", {
    className: classes
  }, /*#__PURE__*/React__default['default'].createElement("input", _extends_1({
...
var CIcon = function CIcon(props) {
  var className = props.className,
      ...
      title = props.title,
      use = props.use,
      attributes = _objectWithoutPropertiesLoose$2(props, ["className", "name", "content", "customClasses", "size", "src", "title", "use"]);
...
var CDataTable = function CDataTable(props) {
  ...
  var headerStyles = function headerStyles(index) {
    ...
    if (fields && fields[index] && fields[index]._style) {
      return _objectSpread$a(_objectSpread$a({}, style), fields[index]._style);
    }
  ...
  var changeSort = function changeSort(column, index) {
    ...
    setSorterState(_objectSpread$a({}, state));
  };
  ...
  var columnFilterEvent = function columnFilterEvent(colName, value, type) {
    ...
    var newState = _objectSpread$a(_objectSpread$a({}, columnFilterState), {}, defineProperty({}, "".concat(colName), value));
  ...
  var tableClasses = ['table', (_ref3 = {}, defineProperty(_ref3, "table-".concat(size), size), defineProperty(_ref3, 'table-dark', dark), defineProperty(_ref3, 'table-striped', striped), defineProperty(_ref3, 'table-hover', hover), defineProperty(_ref3, 'table-bordered', border), defineProperty(_ref3, 'border', outlined), _ref3), addTableClasses];
  ...
  var cleanerProps = {
    content: cilFilterX,
    className: "ml-2 ".concat(isFiltered ? 'text-danger' : 'transparent'),
  ...
  React.useMemo(function () {
    return setSorterState(_objectSpread$a({}, sorterValue));
  }, [sorterValue]);
  React.useMemo(function () {
    return setTableFilterState(tableFilterValue);
  }, [tableFilterValue]);
  React.useMemo(function () {
    return setColumnFilterState(_objectSpread$a({}, columnFilterValue));
  ...
  var paginationProps = _typeof_1(pagination) === 'object' ? pagination : null;
  ...
  })), cleaner && (typeof cleaner === 'function' ? cleaner(clean, isFiltered, cleanerProps) : /*#__PURE__*/React__default['default'].createElement(CIcon, _extends_1({}, cleanerProps, {
    onClick: clean
  ...
  }))), underTableSlot, pagination && /*#__PURE__*/React__default['default'].createElement(CPagination, _extends_1({}, paginationProps, {
    style: {
...
var CTabContent = function CTabContent(props) {
  var className = props.className,
      innerRef = props.innerRef,
      fade = props.fade,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "fade"]); // render


  var classes = classnames('tab-content', className);
  return /*#__PURE__*/React__default['default'].createElement(Context$5.Provider, {
    value: fade
  }, /*#__PURE__*/React__default['default'].createElement("div", _extends_1({
    className: classes
  }, attributes, {
    ref: innerRef
  })));
...
var getState$1 = function getState(r) {
  return r.current.dataset.tab || getIndex$2(r.current);
};
...
var CTabPane = function CTabPane(props) {
  var className = props.className,
      innerRef = props.innerRef,
      active = props.active,
      attributes = objectWithoutProperties(props, ["className", "innerRef", "active"]);

  var _ref = React.useContext(Context$3) || {},
      activeTab = _ref.active,
      setActiveTab = _ref.setActiveTab;

  var fade = React.useContext(Context$5);
  var ref = _typeof_1(innerRef) === 'object' ? innerRef : React.useRef();
  typeof innerRef === 'function' && innerRef(ref);
  ...
  React.useEffect(function () {
    setIsActive(activeTab === getState$1(ref));
  }, [activeTab]);
  React.useEffect(function () {
    if (active !== undefined) {
      setActiveTab ? setActiveTab(active && getState$1(ref)) : setIsActive(active);
    }
  }, [active]); //render
  ...
  var attrs = omitByKeys(attributes, CFadeProps);
  return /*#__PURE__*/React__default['default'].createElement(CFade, _extends_1({
    in: isActive,
    baseClass: fade ? 'fade' : '',
    className: classes
  }, attrs, {
...
var CFooter = function CFooter(props) {
  var Tag = props.tag,
      ...
      innerRef = props.innerRef,
      fixed = props.fixed,
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "fixed"]); //render
...
var CHeader = function CHeader(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "fixed", "colorScheme", "withSubheader"]); // render
...
var CHeaderNavLink = function CHeaderNavLink(props) {
  var className = props.className,
      innerRef = props.innerRef,
      rest = objectWithoutProperties(props, ["className", "innerRef"]); //render
...
var Context$6 = /*#__PURE__*/React__default['default'].createContext({}); //component - CoreUI / CSidebar
...
var CSidebar = function CSidebar(props) {
  var children = props.children,
      ...
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef", "breakpoint", "show", "fixed", "unfoldable", "minimize", "size", "hideOnMobileClick", "aside", "colorScheme", "overlaid", "dropdownMode", "onShowChange", "onMinimizeChange"]);
...
var iconProps = function iconProps(icon) {
  if (_typeof_1(icon) === 'object') {
    var key = icon.size ? 'className' : 'customClasses';
    return _objectSpread$b(_objectSpread$b({}, icon), {}, defineProperty({}, "".concat(key), icon.customClasses || "c-sidebar-nav-icon ".concat(icon.className)));
  } else {
    return {
...
var CSidebarNavDropdown = function CSidebarNavDropdown(props) {
  var children = props.children,
      ...
      show = props.show,
      route = props.route,
      attributes = objectWithoutProperties(props, ["children", "className", "innerRef", "icon", "fontIcon", "name", "show", "route"]);
...
var CSidebarNavItem = function CSidebarNavItem(props) {
  var children = props.children,
      ...
      label = props.label,
      color = props.color,
      rest = objectWithoutProperties(props, ["children", "className", "innerRef", "name", "icon", "fontIcon", "badge", "addLinkClass", "label", "color"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement("li", {
    className: classes,
    ref: innerRef
  }, children || /*#__PURE__*/React__default['default'].createElement(CLink, _extends_1({
    className: linkClasses
  }, routerLinkProps, rest, {
    tabIndex: isOpen === false ? -1 : 0
  }), icon && ( /*#__PURE__*/React.isValidElement(icon) ? icon : /*#__PURE__*/React__default['default'].createElement(CIcon, iconProps(icon))), fontIcon && /*#__PURE__*/React__default['default'].createElement("i", {
    className: "c-sidebar-nav-icon ".concat(fontIcon)
  }), name, badge && /*#__PURE__*/React__default['default'].createElement(CBadge, _objectSpread$c(_objectSpread$c({}, badge), {}, {
    text: null
  }), badge.text)));
};
...
var CScrollbar = function CScrollbar(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "className", "innerRef", "settings", "switcher"]);
...
var CSidebarNav = function CSidebarNav(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(CScrollbar, _extends_1({
    settings: {
...
var CSidebarClose = function CSidebarClose(props) {
  return /*#__PURE__*/React__default['default'].createElement(CButtonClose, _extends_1({}, props, {
...
var css_248z$4 = ".toast-fade {\r\n  transition: opacity .5s;\r\n}\r\n.toast-fade-slow {\r\n  transition: opacity 2s;\r\n}\r\n";
styleInject(css_248z$4);

var Context$7 = /*#__PURE__*/React__default['default'].createContext({}); //component - CoreUI / CToast
...
var CToast = function CToast(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "children", "innerRef", "show", "autohide", "fade", "onStateChange"]);
  ...
  }, state && /*#__PURE__*/React__default['default'].createElement(CFade, _extends_1({
    className: classes,
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true",
...
var CToastHeader = function CToastHeader(props) {
  var className = props.className,
      ...
      innerRef = props.innerRef,
      closeButton = props.closeButton,
      attributes = objectWithoutProperties(props, ["className", "children", "innerRef", "closeButton"]);
...
var CToaster = function CToaster(props) {
  var className = props.className,
      ...
      attributes = objectWithoutProperties(props, ["className", "innerRef", "position"]); // inherit closeButton, autohide, fade??
  // render
...
var CToggler = function CToggler(props) {
  var Tag = props.tag,
      ...
      attributes = objectWithoutProperties(props, ["tag", "children", "className", "innerRef", "inHeader", "inNavbar"]);
...
var CPopover = function CPopover(props) {
  var header = props.header,
      children = props.children,
      content = props.content,
      config = objectWithoutProperties(props, ["header", "children", "content"]);

  var computedContent = React.useCallback(generateContent(content, header), [content, header]);

  var advancedOptions = _objectSpread$e(_objectSpread$e({}, config ? config.advancedOptions || {} : {}), {}, {
    theme: 'cpopover'
  });

  var computedConfig = _objectSpread$e(_objectSpread$e({}, config), {}, {
    advancedOptions: advancedOptions
  });

  return /*#__PURE__*/React__default['default'].createElement(CTooltip, _extends_1({
    content: computedContent
...
var CWidgetProgress = function CWidgetProgress(props) {
  var children = props.children,
      ...
      attributes = objectWithoutProperties(props, ["children", "className", "header", "text", "footer", "color", "value", "inverse"]);
...
var CWidgetIcon = function CWidgetIcon(props) {
  var className = props.className,
      ...
      color = props.color,
      footerSlot = props.footerSlot,
      attributes = objectWithoutProperties(props, ["className", "children", "header", "text", "iconPadding", "color", "footerSlot"]);
...
var CWidgetBrand = function CWidgetBrand(props) {
  var children = props.children,
      ...
      attributes = objectWithoutProperties(props, ["children", "className", "color", "rightHeader", "rightFooter", "leftHeader", "leftFooter", "addHeaderClasses", "bodySlot"]); // render
...
var CWidgetProgressIcon = function CWidgetProgressIcon(props) {
  var children = props.children,
      ...
      attributes = objectWithoutProperties(props, ["children", "className", "header", "text", "value", "color", "inverse", "progressSlot"]);
...
var CWidgetDropdown = function CWidgetDropdown(props) {
  var children = props.children,
      ...
      footerSlot = props.footerSlot,
      text = props.text,
      attributes = objectWithoutProperties(props, ["children", "className", "header", "color", "footerSlot", "text"]);
...
var CWidgetSimple = function CWidgetSimple(props) {
  var children = props.children,
      ...
      header = props.header,
      text = props.text,
      attributes = objectWithoutProperties(props, ["children", "className", "header", "text"]);
